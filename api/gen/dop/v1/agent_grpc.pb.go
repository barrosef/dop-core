...
const (
	AgentService_RunTurn_FullMethodName = "/dop.v1.AgentService/RunTurn"
)
...
func (c *agentServiceClient) RunTurn(ctx context.Context, in *RunTurnRequest, opts ...grpc.CallOption) (*TurnOutcome, error) {
...
func (UnimplementedAgentServiceServer) RunTurn(context.Context, *RunTurnRequest) (*TurnOutcome, error) {
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dop.v1.AgentService",
